...
**原论文Table 3 row (C)**：同时变化了层数$N$、模型维度$d_{model}$和FFN维度$d_{ff}$。
...
**关键发现**：
- $d_{ff}=4096$（$8 \times d_{model}$）时效果最好，PPL=4.75，BLEU=26.2
- 原论文选择$d_{ff}=2048$（$4 \times d_{model}$）是在性能和参数量之间的权衡
- 更大的$d_{ff}$提升效果，但参数量也显著增加（4096时参数量90M vs base的65M）
...
![Diagram 1](https://mermaid.-W3riJ8IEUzCiAgICAgICAgRTMgLS0-IEU0CiAgICAgICAgRTQgLS0--fCLmrovlt64ifCBEMwogICAgICAgIEQzIC0tPiBENAogICAgICAgIEQ0IC0tPiBENQogICAgICAgIEQzIC0uLT58Iuaui-W3riJ8IEQ1CiAgICAgICAgRDUgLS0-IEQ2CiAgICAgICAgRDYgLS0-IEQ3CiAgICAgICAgRDUgLS4tPnwi5q6L5beuInwgRDcKICAgICAgICBENyAtLT4gRDgKICAgIGVuZAogICAgCiAgICBzdHlsZSBFNCBmaWxsOiNmZmY0ZTEKICAgIHN0eWxlIEQ2IGZpbGw6I2ZmZjRlMQ==)
